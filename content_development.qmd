...
During my time as a Graduate Student in the Faculty of Forestry, I have been involved in course and content development for both undergraduate and graduate programs. On this page, I have collected a few content development "highlights".
...
To view the complete field lab, visit this [link](https://ramonmelser.github.io/MKRF_Map/).
:::
...
::: {style="border-radius: 0.8em; padding: 0.5px 25px; background-color: #e6e6eb"}
## Interactive Urban Heat Island Tool

Several of UBC Forestry's undergraduate courses introduce students to remote sensing platforms and applications. For introductory courses, ready-made tools are a great way to engage students without requiring prerequisite coding/programming knowledge. To this end, I developed an app in Google Earth Engine, providing an interactive interface that students can use to explore surface temperatures observed by the thermal infrared sensors onboard Landsat 9. To use the tool, navigate to any location in the world using the search bar, fill out your desired start/end dates and maximum cloud cover, and hit 'apply filters'. The maximum observed surface temperature during your specified time-period is now displayed, with areas exceeding 35C highlighted in red. You can also click anywhere in your area to generate a time-series graph of surface temperature at that particular location. Finally, to observe any relationships between thermal observations and land cover, a 'True Colour' image can be toggled on in the 'Layers' tab. To view the explorer tool in full-screen, visit <https://ee-melserramon.projects.earthengine.app/view/thermal-analysis-tool>
:::

<br>

<iframe width="800" height="700" src="https://ee-melserramon.projects.earthengine.app/view/thermal-analysis-tool" title="Google Earth Engine - Landsat Thermal Analysis Tool">
